...
router.get("/banner", (req, res) => {
	res.json({
		code: 1,
		data: [
			"http://" + IPAdress + ":3000/images/a.jpg",
			"http://" + IPAdress + ":3000/images/b.jpg",
			"http://" + IPAdress + ":3000/images/c.jpg",
			"http://" + IPAdress + ":3000/images/d.jpg",
			"http://" + IPAdress + ":3000/images/e.jpg"
		]
	})
})
